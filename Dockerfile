...
FROM python:3.11.1-alpine as runtime
...
# Copy .venv virtual environment directory from builder
...
#CMD set -xe;  manage.py migrate --noinput; gunicorn website.wsgi:application
